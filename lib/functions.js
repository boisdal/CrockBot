...
export const ANDTest = function (cooker, names, tags) { return this.item1.test(cooker, names, tags) && this.item2.test(cooker, names, tags); };
export const ORTest = function (cooker, names, tags) { return this.item1.test(cooker, names, tags) || this.item2.test(cooker, names, tags); };
export const NAMETest = function (_cooker, names, _tags) { return (names[this.name] || 0) + (names[this.name + '_cooked'] || 0); };
export const NOTTest = function (cooker, names, tags) { return !this.item.test(cooker, names, tags); };
export const SPECIFICTest = function (_cooker, names, _tags) { return names[this.name]; };
export const TAGTest = function (_cooker, _names, tags) { return tags[this.tag]; };
